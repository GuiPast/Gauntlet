...
{
    /*
     * Subtype of Sprite class to represent every movable sprite (for instance, the main character, the enemies or the weapons)
     */ 
    class MovableSprite: Sprite
    {
        const byte TOTAL_MOVEMENTS = 8;
        const byte SPRITE_CHANGE = 10;
        public enum SpriteMovement { LEFT, LEFT_UP, UP, RIGHT_UP, RIGHT, RIGHT_DOWN, DOWN, LEFT_DOWN };
